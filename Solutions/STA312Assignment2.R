...
hist(y, main = "Q2C: Histogram of max for a sample of of exponential(1)",ylab="Frequency", xlab= "Y",prob= T, col="green")
simulated_mean<-mean(y)
simulated_mean
simulated_variance <-var(y)
simulated_variance
...
hist(y, main = "Q3B: Histogram of N(0,1)",ylab="Frequency", xlab= "Y",prob= T, col="green")
simulated_mean <-mean(y)
simulated_mean
simulated_variance <-var(y)
simulated_variance
...
sim.variance = var(x)
sim.variance
hist(x, prob=T, main = "Q4C: Generating distribution of random variable, F by AR method", col="green", xlab = "X", ylab="Frequency")
